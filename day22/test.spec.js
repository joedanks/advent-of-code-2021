...
const loadInput = () => {
    return JSON.parse(fs.readFileSync('src/day22/input.json', 'utf-8'))
}
...
describe('Part 1', () => {
    it('should pass test input', () => {
        expect(partOne(testInput)).toBe(590784)
    })
    it('should run real input', () => {
        const actual = partOne(loadInput());
        expect(actual).toBe(653798)
    })
});
